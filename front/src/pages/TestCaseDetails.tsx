  ...
  if (!testCase) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-semibold text-gray-900">Test Case not found</h2>
        <button
          ...
          <div>
            ...
            <div className="mt-4 flex items-center space-x-4 text-sm">
              <div className="flex items-center">
                ...
                <span className="text-gray-600">Created {formatDate(testCase.createdAt)}</span>
              </div>
              <div className="text-gray-600">by {testCase.createdBy}</div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-medium text-gray-700">Expected Result:</h3>
